    ...
    <div class="posts col-8">
      ...
      <div class="row add-post">
        <form action="edit.php" method="post" enctype="multipart/form-data">
          ...
          <div class="col">
            <input name="title" value="<?=$post['title']?>" class="form-control form-control-lg" id="floatingInputInvalid" placeholder="Заголовок">
          </div>
          <div class="form-floating">
            <textarea name="content" value="<?=$post['content']?> class="form-control" placeholder="Leave a comment here" id="editor" style="height: 100px;"></textarea>
          </div>
          ...
          <div class="col-auto">
            <?php if (empty($publish) && $publish == 0): ?>
              ...
              <label>Подтверди для публикации</label>
            <?php else: ?>
